            ...
            <div class="row">
                ...
                <div class="col-xl-3 col-sm-6 p-b-15 lbl-card">
                    <div class="card card-mini dash-card card-4">
                        <div class="card-body">
                          @if($DailyRevenue[0]->amount)
                            <h2 class="mb-1"> {{$DailyRevenue[0]->amount}} AED</h2>
                          @else
                          <h2 class="mb-1">0 AED</h2>
                          @endif
                            <p>Daily Revenue</p>
                        ...
                        <div class="card-footer d-flex flex-wrap bg-white p-0">
                                ...
                                <div class="p-20">
                                    <ul class="d-flex flex-column justify-content-between">
                                      <li class="mb-2"><i class="mdi mdi-checkbox-blank-circle-outline mr-2"
                                        style="color: #8061ef"></i>Order Shoping</li>
                                        
                                        <li class="mb-2"><i class="mdi mdi-checkbox-blank-circle-outline mr-2"
                                                            style="color: #80e1c1 "></i>Order in delivery</li>
                                        <li><i class="mdi mdi-checkbox-blank-circle-outline mr-2"
                                               style="color: #ff7b7b "></i>Order in process</li>
                                    </ul>
                                </div>
                            </div>
                            <div class="col-6 border-left">
                                <div class="p-20">
                                    <ul class="d-flex flex-column justify-content-between">
                                      <li class="mb-2"><i class="mdi mdi-checkbox-blank-circle-outline mr-2"
                                        style="color: #4c84ff"></i>Order Deliverd</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-xl-5 col-12 p-b-15">
                    ...
                    <div class="card card-default Sold-card-table">
                        ...
                        <div class="card-body py-0 compact-units" data-simplebar style="height: 200px;">
                            <table class="table ">
                                <tbody>
                                    @foreach($SoldbyItems as $SoldbyItem )
                                <tr>
                                    <td class="text-dark">{{$SoldbyItem->name}}</td>
                                    <td class="text-center">{{$SoldbyItem->quantity}}</td>
                                </tr>
                                @endforeach
                          ...
                          <div class="card-body pt-0 pb-5">
                              <table class="table card-table table-responsive table-responsive-large"
                                  ...
                                  <tr>
                                      ...
                                      <td>
                                          <a class="text-dark" href="#">{{$RecentOrder->name}}</a>
                                      </td>
                                      <td class="d-none d-lg-table-cell">{{$RecentOrder->quantity}}</td>
                                      <td class="d-none d-lg-table-cell">{{$RecentOrder->created_at}}</td>
                                      <td class="d-none d-lg-table-cell">{{$RecentOrder->amount}}</td>
                                      <td>
                                        ...
                                        <div class="media">
                                            <div class="media-image mr-3 rounded-circle">
                                                <a href="#"><img
                                                        ...
                                                        src="{{asset('media/logos/bagdones_logo.svg')}}"
                                                        alt="customer image"></a>
                                            </div>
                                            <div class="media-body align-self-center">
                                                <a href="#">
                                                    <h6 class="mt-0 text-dark font-weight-medium">{{$NewCustomer->full_name}}</h6>
                                                </a>
                        ...
                        <div class="card-body mt-10px mb-10px py-0">
                            <div class="row media d-flex pt-15px pb-15px">
                                <div
                                    ...
                                    <a href="#"><img src="{{('admin/assets/img/products/p1.jpg')}}" alt="customer image"></a>
                                </div>
                                <div class="col-lg-9 col-md-9 col-10 media-body align-self-center ec-pos">
                                    ...
                                    <p class="mb-0 ec-price">
                                        <span class="text-dark">520 AED</span>
                                        <del>580 AED</del>
                                    </p>
                                </div>
                            </div>
                            <div class="row media d-flex pt-15px pb-15px">
                                <div
                                    class="col-lg-3 col-md-3 col-2 media-image align-self-center rounded">
                                    <a href="#"><img src="{{('admin/assets/img/products/p2.jpg')}}" alt="customer image"></a>
                                </div>
                                <div class="col-lg-9 col-md-9 col-10 media-body align-self-center ec-pos">
                                    <a href="#">
                                    ...
                                    <p class="d-none d-md-block">Statement belting with double-turnlock hardware
                                        adds “swagger” to a simple.</p>
                                    <p class="mb-0 ec-price">
                                        <span class="text-dark">250 AED</span>
                                        <del>300 AED</del>
                                    </p>
                                </div>
                            </div>
                            <div class="row media d-flex pt-15px pb-15px">
                                <div
                                    class="col-lg-3 col-md-3 col-2 media-image align-self-center rounded">
                                    <a href="#"><img src="{{('admin/assets/img/products/p3.jpg')}}" alt="customer image"></a>
                                </div>
                                <div class="col-lg-9 col-md-9 col-10 media-body align-self-center ec-pos">
                                    <a href="#">
                                    ...
                                    <p class="d-none d-md-block">Statement belting with double-turnlock hardware
                                        adds “swagger” to a simple.</p>
                                    <p class="mb-0 ec-price">
                                        <span class="text-dark">480 AED</span>
                                        <del>654 AED</del>
                                    </p>
                                </div>
                            </div>
...
$(document).ready(function() {
  ...
  var countShoping = {{$countShoping[0]->recived}} ;

  var countrecived = {{$countrecived[0]->recived}} ;

  var countin_process = {{$countin_process[0]->in_process}} ;

  var countin_delivery = {{$countin_delivery[0]->in_delivery}} ;

  var countdeliverd = {{$countdeliverd[0]->deliverd}} ;
  ...
  if (doughnut !== null) {
    var myDoughnutChart = new Chart(doughnut, {
      type: "doughnut",
      data: {
        labels: ["deliverd", "in delivery", "in process", "Shoping","recived"],
        datasets: [
          {
            label: ["deliverd", "in delivery", "in process", "Shoping","recived"],
            data: [countdeliverd, countin_delivery, countin_process, countShoping, countrecived],
  ...
  if (hbar2 !== null) {
    var hbChart2 = new Chart(hbar2, {
      type: "horizontalBar",
      data: {
        labels: ["Sharjah", "Ajman", "Ras Al-Khaimah"],
        datasets: [
          {
            label: "signup",
            data: [7.5, 4.6, 4],
