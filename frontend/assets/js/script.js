...
$('.tap-top').on('click', function() {
  ...
  /*=====================
   19. Filter sidebar js
   ==========================*/
  function openFilter() {
    document.getElementById("Filter_side").classList.add('open-side');
  }
  function closeFilter() {
    document.getElementById("Filter_side").classList.remove('open-side');
  }
