    ...
    <div class="row">
      <div class="col">
        <div class="breadcrumb-contain">
          <div>
            <h2>{{App::getLocale() == 'en' ? $item->name : $item->name_locale }}</h2>
            <ul>
              <li><a href="{{route('ecommerce')}}">@lang('product_details.Home')</a></li>
              <li><i class="fa fa-angle-double-right"></i></li>
              <li><a href="javascript:void(0)">
                {{App::getLocale() == 'en' ? $item->subCategory->name : $item->subCategory->name_locale }} </a></li>
              <li><i class="fa fa-angle-double-right"></i></li>
              <li><a href="javascript:void(0)">
            ...
            <div class="product-service">
              <div class="media">
                ...
                <div class="media-body">
                  <h4>@lang('product_details.free shipping')</h4>
                  <p>@lang('product_details.free shipping world wide')</p>
                </div>
              </div>
              <div class="media">
                ...
                <div class="media-body">
                  <h4>@lang('product_details.24 X 7 service')</h4>
                  <p>@lang('product_details.online service for new customer')</p>
                </div>
              </div>
              <div class="media">
                ...
                <div class="media-body">
                  <h4>@lang('product_details.festival offer')</h4>
                  <p>@lang('product_details.new online special festival offer')</p>
                </div>
              </div>
              <div class="media border-0 m-0">
                ...
                <div class="media-body">
                  <h4>@lang('product_details.Online Payment')</h4>
                  <p>@lang('product_details.Contrary to popular belief.')</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="row ">
              <div class="col-lg-5">
                <div class="product-slick ">
                  ...
                  <div>
                    <img src="{{asset('uploads/items/' . $image->image)}}" alt="" class="img-fluid  image_zoom_cls-{{$i}}">
                     </div>
                  @php $i++ @endphp
                 @endforeach
                 @if($item->images->count() == 0)
                 <img src="{{asset('uploads/items/' . $item->main_screen_image)}}" alt="" class="img-fluid  image_zoom_cls-{{$i}}">
                 @endif
                </div>
                <div class="row">
                  <div class="col-12 p-0">
                    <div class="slider-nav">
                      ...
                      @foreach($item->images as $image)
                      <div> 
                        <img src="{{asset('uploads/items/' . $image->image)}}" alt="" class="img-fluid">                 
                      </div>
                      @php $i++ @endphp
                     @endforeach
              ...
              <div class="col-lg-7 rtl-text">
                <div class="product-right ">
                  <div class="pro-group">
                    ...
                    <ul class="pro-price">
                      @if($item->price != Null)
                      <li> {{$item->new_price}}@lang('product_details.AED')  </li><br/>
                      <li><span> {{$item->price}} @lang('product_details.AED') </span></li>
                      <p style="display:none"> {{$price = 100 - $item->new_price / $item->price * 100}} </p> 
                      <li style=" background-color: red; width: 3rem; text-align: center;color:white ">{{ (int) $price }} %</li>  
                      @else
                      <li> {{$item->new_price}} @lang('product_details.AED') </li>
                      @endif
                    </ul>
                    <div class="revieu-box">
                      ...
                      <a href="#"><span>@lang('product_details.(6 reviews)')</span></a>
                    </div>
                    <ul class="best-seller">
                      <li>
                        ...
                        @lang('product_details.3 Best Seller') 
                      </li>
                      <li>
                        ...
                        @lang('product_details.44 Active View This')
                      </li>
                    </ul>
                  </div>
                  <div class="pro-group">
                    <h6 class="product-title">@lang('product_details.hurry  up ! Deal end in :')</h6>
                    <div class="timer">
                      <p id="demo">
                      </p>
                    </div>
                  ...
                  <div id="selectSize" class="pro-group addeffect-section product-description border-product mb-0">
                    @foreach($item->itemAttributes as $itemAttribute)
                                    <h6 class="product-title size-text"><span>
                                                      <a href="#">{{$itemAttribute->name}}</a></span></h6>
                                    <div class="modal fade" id="sizemodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                      <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                          <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">@lang('product_details.Sheer Straight Kurta')</h5>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                          </div>
                                          <div class="modal-body"><img src="{{asset('frontend/assets/images/size-chart.jpg')}}" alt="" class="img-fluid "></div>
                                        </div>
                                      </div>
                                    </div>
                                    <h6 class="error-message">@lang('product_details.please select size')</h6>
                                   
                                    <div class="@if($itemAttribute->id == 3) color-selector @endif inline @if($itemAttribute->id != 3) size-box @endif" id="selectSize">
                                      <ul>
                                       @foreach($itemAttribute->entries as $entrie)
                                        @if($entrie->is_active =='1' && $entrie->attribute_id =='3')
                                        <li> <div style=" background-color:{{$entrie->name}}; "></div> </li>
                                        @elseif($entrie->attribute_id =='2')
                                       <li style=" margin-top: 1rem; "> {{$entrie->name}} </li>
                                          @else
                                          <li style="border: 1px;border-style: dashed;"> {{$entrie->name}}</li>
                                          @endif
                                        @endforeach
                                      </ul>
                                    </div>
                                     ...
                                     <div class="product-buttons">
                                      <a href="javascript:void(0)" id="cartEffect" onclick="addToCart({{$item->id}})" class="btn cart-btn btn-normal tooltip-top" data-tippy-content="@lang('product_details.add to cart')">
                                        <i class="fa fa-shopping-cart"></i>
                                        @lang('product_details.add to cart')                                       
                                      </a>
                                      <a href="{{ route('add.to.wishlist', $item->id) }}" class="btn btn-normal add-to-wish tooltip-top" data-tippy-content="@lang('product_details.Add to wishlist')">
                  ...
                  <div class="pro-group">
                    <h6 class="product-title">@lang('product_details.delivery location')</h6>
                    <div class="delivery-detail">
                      <div class="delivery-detail-contian">
                        ...
                        <a href="javascript:void(0)" class="btn btn-solid btn-md ">@lang('product_details.check')</a>
                      </div>
                      <div class="delivery-lable">
                        ...
                        @lang('product_details.order within 12 hrs') 
                      </div>
                    </div>
                  </div>
                  <div class="pro-group">
                    <div class="product-offer">
                      <h6 class="product-title"><i class="fa fa-tags"></i>@lang('product_details.5 offers Available')  </h6>
                      <div class="offer-contain">
                        <ul>
                          <li>
                            <span class="code-lable"> @lang('product_details.OFFER40') </span>
                            <div>
                              <h5>@lang('product_details.Get extra $40 off on first Orders')</h5>
                              <p>@lang('product_details.Use code "OFFER40" Min. Cart Value $99 | Max. Discount $40')</p>
                            </div>
                          </li>
                        </ul>
                        <ul class="offer-sider">
                          <li>
                            <span class="code-lable">@lang('product_details.OFFER25')</span>
                            <div>
                              <h5>@lang('product_details.Get extra $25 off on second Orders')</h5>
                              <p>@lang('product_details.Use code "OFFER25" Min. Cart Value $99 | Max. Discount $25')</p>
                            </div>
                          </li>
                          <li>
                            <span class="code-lable">@lang('product_details.OFFER40')</span>
                            <div>
                              <h5>@lang('product_details.Bank Offer40% Unlimited Cashback on bideal Axis Bank Credit Card')</h5>
                              <p>@lang('product_details.Use code "OFFER40" Min. Cart Value $99 | Max. Discount $40')</p>
                            </div>
                          </li>
                          <li>
                            <span class="code-lable">@lang('product_details.OFFER10')</span>
                            <div>
                              <h5>@lang('product_details.Bank Offer10% off* with Axis Bank Buzz Credit Card')</h5>
                              <p>@lang('product_details.Use code "OFFER10" Min. Cart Value $99 | Max. Discount $10')</p>
                            </div>
                          </li>
                           
                        </ul>
                        <h5 class="show-offer"><span class="more-offer">@lang('product_details.show more offer')</span><span class="less-offer">@lang('product_details.less offer')</span></h5>
                      </div>
                    </div>
                  </div>
                  <div class="pro-group">
                    <h6 class="product-title">@lang('product_details.product infomation')</h6>
                    <p>@lang('product_details.Sed ut perspiciatis, unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam eaque ipsa, quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt, explicabo. Nemo enim ipsam voluptatem,')</p>
                  </div>
                  <div class="pro-group">
                    <h6 class="product-title">@lang('product_details.Delivery option')</h6>
                    <ul class="delivery-services">
                      <li>
                        ...
                        @lang('product_details.free shipping')  
                      </li>
                      <li>
                        ...
                        @lang('product_details.10 Days Returnable') 
                      </li>
                      <li>
                        ...
                        @lang('product_details.1 Year Warranty')   
                      </li>
                    </ul>
                  </div>
                  <div class="pro-group pb-0">
                    <h6 class="product-title"> @lang('product_details.share')   </h6>
            ...
            <div class="row">
              <div class="col-sm-12 col-lg-12">
                <ul class="nav nav-tabs nav-material" id="top-tab" role="tablist">
                  <li class="nav-item"><a class="nav-link active" id="top-home-tab" data-bs-toggle="tab" href="#top-home" role="tab" aria-selected="true"><i class="icofont icofont-ui-home"></i>@lang('product_details.Description')</a>
                    <div class="material-border"></div>
                  </li>
                  
                  
                  <li class="nav-item"><a class="nav-link" id="review-top-tab" data-bs-toggle="tab" href="#top-review" role="tab" aria-selected="false"><i class="icofont icofont-contacts"></i> @lang('product_details.Write Review')</a>
                    <div class="material-border"></div>
                  </li>
                </ul>
                  ...
                  <div class="tab-pane fade" id="top-review" role="tabpanel" aria-labelledby="review-top-tab">
                    <form class="theme-form">
                      <div class="row">
                        <div class="col-md-12">
                          <div class="media">
                            <label>@lang('product_details.Rating')</label>
                        ...
                        <div class="col-md-6">
                          <label for="name">@lang('product_details.Name')</label>
                          <input type="text" class="form-control" id="name" placeholder="Enter Your name" required>
                        </div>
                        <div class="col-md-6">
                          <label >@lang('product_details.Email')</label>
                          <input type="text" class="form-control"  placeholder="Email" required>
                        </div>
                        <div class="col-md-12">
                          <label >@lang('product_details.Review Title')</label>
                        ...
                        <div class="col-md-12">
                          <button class="btn btn-normal" type="submit">@lang('product_details.Submit YOur Review')</button>
                        </div>
                      </div>
                    </form>
                  </div>
  ...
  <div class="custom-container">
    <div class="row">
      <div class="col-12 product-related">
        <h2>@lang('product_details.related products')</h2>
      </div>
    </div>
    <div class="row">
      <div class="col-12 product">
        <div class="product-slide-6 product-m no-arrow">
          @foreach($itemssuggest as $itemsuggest)
          <div>
            <div class="product-box">
              <div class="product-imgbox" style=" margin-bottom: 10px; ">
                <div class="product-front">
                  <a href="{{asset('/product_details/') .'/'. $itemsuggest->id}}">
                    <img src="{{ asset('uploads/items/' . $itemsuggest->main_screen_image)}}" class="img-fluid  " style=" height: 250px;" alt="product">
                  </a>
                </div>
              ...
              <div class="{{asset('/product_details/') .'/'. $itemsuggest->id}}">
                <div class="detail-title">
                  <div class="detail-left">
                    <a href="{{asset('/product_details/') .'/'. $itemsuggest->id}}">
                      <h6 class="price-title">
                        @if(strlen($itemsuggest->name) > 22)
                        {{App::getLocale() == 'en' ? substr($itemsuggest->name,0,20) : substr($itemsuggest->name_locale,0,20) }}
                            @else
                            {{App::getLocale() == 'en' ? $itemsuggest->name : $itemsuggest->name_locale }}
                             @endif
                      </h6>
                    </a>
                  </div>
                  @if($itemsuggest->price != Null)
                  <div class="detail-right">
                    <div class="check-price" style="text-decoration: line-through;">
                      {{$itemsuggest->price}} @lang('product_details.AED')
                    </div>
                    <div class="price">
                      <div class="price">
                        {{$itemsuggest->new_price}} @lang('product_details.AED')
                      </div>
                    </div>
                  </div>
                  @else
