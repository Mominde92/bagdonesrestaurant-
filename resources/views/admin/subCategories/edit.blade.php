    ...
    <div class="ec-content-wrapper">
        <div class="content">
            <div class="breadcrumb-wrapper d-flex align-items-center justify-content-between">
                ...
                <div>
                    <a href="{{url('subCategory')}}" class="btn btn-primary"> View All
                    </a>
                </div>
            </div>
            <div class="row">
                    ...
                    <div class="card card-default">
                        ...
                        <div class="card-body">
                            <div class="row ec-vendor-uploads">
                                <div class="col-lg-4">
                                    <form class="row g-3" action="{{ url('subCategory/update',$category->id) }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
