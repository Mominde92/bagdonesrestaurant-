            ...
            <div class="language-block">
              ...
              <div class="curroncy-dropdown">
                ...
                <ul class="curroncy-dropdown-open">
                  <li><a href="javascript:void(0)"><i class="fa fa-inr"></i>Aed</a></li>
                </ul>
              </div>
            </div>
          </div>
        ...
        <div class="main-menu-block">
          <div class="header-left">
            ...
            <div class="brand-logo logo-sm-center">
              <a href="#">
                <img src="http://themes.pixelstrap.com/bigdeal/assets/images/layout-2/logo/logo.png" class="img-fluid  " alt="logo">
              </a>
            </div>
          </div>
              ...
              <div class="nav-left" >
                ...
                <div class="collapse  nav-desk" id="navbarToggleExternalContent">
                  <ul class="nav-cat title-font">
                    <li> <a href="category-page(left-sidebar).html"><img src="http://themes.pixelstrap.com/bigdeal/assets/images/layout-1/nav-img/01.png" alt="category-product"> western ware</a></li>
                    <li> <a href="category-page(left-sidebar).html"><img src="http://themes.pixelstrap.com/bigdeal/assets/images/layout-1/nav-img/02.png" alt="category-product"> TV, Appliances</a></li>
                    <li> <a href="category-page(left-sidebar).html"><img src="http://themes.pixelstrap.com/bigdeal/assets/images/layout-1/nav-img/03.png" alt="category-product"> Pets Products</a></li>
                    <li> <a href="category-page(left-sidebar).html"><img src="http://themes.pixelstrap.com/bigdeal/assets/images/layout-1/nav-img/04.png" alt="category-product"> Car, Motorbike</a></li>
                    <li> <a href="category-page(left-sidebar).html"><img src="http://themes.pixelstrap.com/bigdeal/assets/images/layout-1/nav-img/05.png" alt="category-product"> Industrial Products</a></li>
                    <li> <a href="category-page(left-sidebar).html"><img src="http://themes.pixelstrap.com/bigdeal/assets/images/layout-1/nav-img/06.png" alt="category-product"> Beauty, Health Products</a></li>
                    <li> <a href="category-page(left-sidebar).html"><img src="http://themes.pixelstrap.com/bigdeal/assets/images/layout-1/nav-img/07.png" alt="category-product"> Grocery Products </a></li>
                    <li> <a href="category-page(left-sidebar).html"><img src="http://themes.pixelstrap.com/bigdeal/assets/images/layout-1/nav-img/08.png" alt="category-product"> Sports</a></li>
                    <li> <a href="category-page(left-sidebar).html"><img src="http://themes.pixelstrap.com/bigdeal/assets/images/layout-1/nav-img/09.png" alt="category-product"> Bags, Luggage</a></li>
                    <li> <a href="category-page(left-sidebar).html"><img src="http://themes.pixelstrap.com/bigdeal/assets/images/layout-1/nav-img/10.png" alt="category-product"> Movies, Music </a></li>
                    <li> <a href="category-page(left-sidebar).html"><img src="http://themes.pixelstrap.com/bigdeal/assets/images/layout-1/nav-img/11.png" alt="category-product"> Video Games</a></li>
                    <li> <a href="category-page(left-sidebar).html"><img src="http://themes.pixelstrap.com/bigdeal/assets/images/layout-1/nav-img/12.png" alt="category-product"> Toys, Baby Products</a></li>
                    <li>
                      ...
                      <li>
                        <div class="container">
                          ...
                          <div class="row menu-banner">
                            <div class="col-lg-6">
                              <div>
                                <img src="http://themes.pixelstrap.com/bigdeal/assets/images/menu-banner1.jpg" alt="menu-banner" class="img-fluid">
                              </div>
                            </div>
                            <div class="col-lg-6">
                              <div>
                                <img src="http://themes.pixelstrap.com/bigdeal/assets/images/menu-banner2.jpg" alt="menu-banner" class="img-fluid">
                              </div>
                            </div>
                          </div>
                        </div>
                          ...
                          <div class="row">
                            ...
                            <div class="col mega-box">
                              <div class="link-section">
                                ...
                                <div class="menu-content">
                                  <ul>
                                    <li><a href="http://themes.pixelstrap.com/bigdeal/email-template/email-order-success.html">order success</a></li>
                                    <li><a href="http://themes.pixelstrap.com/bigdeal/email-template/email-order-success-tow.html">order success 2</a></li>
                                    <li><a href="http://themes.pixelstrap.com/bigdeal/email-template/email-template.html">email template</a></li>
                                    <li><a href="http://themes.pixelstrap.com/bigdeal/email-template/email-template-tow.html">email template 2</a></li>
                                  </ul>
                                </div>
                            ...
                            <div class="col mega-box product ">
                              <div class="mega-img">
                                <img src="http://themes.pixelstrap.com/bigdeal/assets/images/mega-banner.jpg" alt="menu-banner" class="img-fluid">
                              </div>
                            </div>
                          </div>
                        </div>
                  ...
                  <li>
                    ...
                    <ul>
                      <li>
                        ...
                        <ul>
                          <li><a href="http://themes.pixelstrap.com/bigdeal/invoice-template/element-invoice.html">invoice one</a></li>
                          <li><a href="http://themes.pixelstrap.com/bigdeal/invoice-template/element-invoice2.html">invoice two</a></li>
                          <li><a href="http://themes.pixelstrap.com/bigdeal/invoice-template/element-invoice3.html">invoice three</a></li>
                          <li><a href="http://themes.pixelstrap.com/bigdeal/invoice-template/element-invoice4.html">invoice four</a></li>
                          <li><a href="http://themes.pixelstrap.com/bigdeal/invoice-template/element-invoice5.html">invoice five</a></li>
                        </ul>
                      </li>
                      <li>
            ...
            <div class="category-right">
              ...
              <div class="btn-group">
                ...
                <div class="dropdown-menu gift-dropdown">
                  <div class="media">
                    <div  class="me-3">
                      <img src="http://themes.pixelstrap.com/bigdeal/assets/images/icon/1.png" alt="Generic placeholder image">
                    </div>
                    <div class="media-body">
                      <h5 class="mt-0">Billion Days</h5>
                      <p><img src="http://themes.pixelstrap.com/bigdeal/assets/images/icon/currency.png" class="cash" alt="curancy"> Flat Rs. 270 Rewards</p>
                    </div>
                  </div>
                  <div class="media">
                    <div  class="me-3">
                      <img src="http://themes.pixelstrap.com/bigdeal/assets/images/icon/2.png" alt="Generic placeholder image" class="gift-bloc">
                    </div>
                    <div class="media-body">
                      <h5 class="mt-0">Fashion Discount</h5>
                      <p><img src="http://themes.pixelstrap.com/bigdeal/assets/images/icon/fire.png"  class="fire" alt="fire">Extra 10% off (upto Rs. 10,000*) </p>
                    </div>
                  </div>
                  <div class="media">
                    <div  class="me-3">
                      <img src="http://themes.pixelstrap.com/bigdeal/assets/images/icon/3.png" alt="Generic placeholder image">
                    </div>
                    <div class="media-body">
                  ...
                  <div class="media">
                    <div  class="me-3">
                      <img src="http://themes.pixelstrap.com/bigdeal/assets/images/icon/6.png" alt="Generic placeholder image">
                    </div>
                    <div class="media-body">
                  ...
                  <div class="media">
                    <div  class="me-3">
                      <img src="http://themes.pixelstrap.com/bigdeal/assets/images/icon/5.png" alt="Generic placeholder image">
                    </div>
                    <div class="media-body">
