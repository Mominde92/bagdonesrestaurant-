                            ...
                            <div class="avatar-upload">
                                ...
                                <div class="avatar-preview ec-preview">
                                    <div class="imagePreview ec-div-preview">
                                        <img class="ec-image-preview" src="{{asset('/uploads/stores/'. $store->image)}}" alt="edit">
                                    </div>
                                </div>
                            </div>
                            <p> Cover Image </p>
                                ...
                                <div class="thumb-upload">
                                    ...
                                    <div class="thumb-preview ec-preview">
                                        <div class="image-thumb-preview">
                                            <img class="image-thumb-preview ec-image-preview" src="{{asset('/uploads/stores/'. $store->cover_image)}}" alt="edit">
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-lg-8">
                    <div class="ec-vendor-upload-detail row">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" name="name"  id="name" value="{{ $store->name }}" placeholder="Enter Store Name" required>
                        </div>

                        <div class="col-md-6">
                            <label for="name_locale" class="form-label">Name local</label>
                            <input type="text" class="form-control" name="name_locale" value="{{ $store->name_locale }}" placeholder="Enter Store Locale Name">
                        </div>

                        <div class="col-md-6">
                            <label>Slogan<span class="text-danger">*</span></label>
                            <input type="text" name="slogan" required class="form-control" value="{{ $store->slogan }}" placeholder="Enter Store Slogan" />
                        </div>
                        <div class="col-md-6">
                    ...
                    <span class="switch">
                        <label>
                    <input type="checkbox"  name="allow_add_hot_price" <?= $store->allow_add_hot_price == true? 'checked="checked"' : '' ?> />                            <span></span>
                        </label>
                    </span>
                            </div>
                        </div>
