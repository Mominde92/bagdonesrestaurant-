    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            <div class="card-title">
                <h3 class="card-label">Areas
                    <div class="text-muted pt-2 font-size-sm">All Areas Datatable</div>
                </h3>
            </div>
            ...
            var table = $('.main_datatable').DataTable({
                ...
                columns: [
                    ...
                    {data: 'city_name', name: 'city_name'},
                    {
                        ...
                        {
                            var show_url = "{{ URL::to('/area') }}/"+data;
                            var edit_url = "{{ URL::to('/area/edit') }}/"+data;
