        ...
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            <div class="card-title">
                <h3 class="card-label">States
                    <div class="text-muted pt-2 font-size-sm">All States Datatable</div>
                </h3>
            </div>
            <div class="card-toolbar">
                <!--begin::Button-->
                <a href="{{ route('state.create') }}" class="btn btn-primary font-weight-bolder">
            ...
            var table = $('.main_datatable').DataTable({
                ...
                columns: [
                    ...
                    {data: 'country_name', name: 'country_name'},
                    {
                        ...
                        {
                            var show_url = "{{ URL::to('/state') }}/"+data;
                            var edit_url = "{{ URL::to('/state/edit') }}/"+data;
